...
int main()
{
	Mat img = imread("E:/WORK/Radiology/Data/L spine/1111118031_6.tiff", IMREAD_GRAYSCALE); // Read in the image file
	...
	Mat histImage(hist_h, hist_w, CV_16UC3, Scalar(255, 255, 255));
	...
	imwrite("Original_Image_Histogram.tiff", histImage);
	...
	imwrite("Equalized_Image_Histogram.tiff", outHistImage);
	...
	imwrite("Equalized_Image.tiff", out);
