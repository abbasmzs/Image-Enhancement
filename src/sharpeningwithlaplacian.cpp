...
int main()
{
	Mat img = imread("E:/WORK/Radiology/Data/Abdomen/1111118092_6.tiff");
	Mat laplacianSharpening, unsharpSharpening;

	// Laplacian sharpening
	float laplacianBoostFactor = 1.1; // Controls the amount of Laplacian Sharpening
	...
	float unsharpBoostFactor = 12; // Controls the amount of Unsharp Mask Sharpening
